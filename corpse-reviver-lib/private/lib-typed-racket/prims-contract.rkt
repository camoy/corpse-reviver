...
(require corpse-reviver/private/typed-racket)
...
(require (for-template (submod "." forms) typed-racket/utils/require-contract
...
(require racket/lazy-require
         ...
         syntax/struct
         syntax/location
         (for-template typed-racket/utils/any-wrap)
         typed-racket/utils/tc-utils
         typed-racket/private/syntax-properties
         typed-racket/private/cast-table
         ...
         typed-racket/utils/struct-extraction
         (for-syntax typed-racket/utils/struct-extraction
                     typed-racket/base-env/type-name-error)
         (only-in typed-racket/utils/utils syntax-length)
         (for-template racket/base typed-racket/base-env/ann-inst))

;; Lazily loaded b/c they're only used sometimes, so we save a lot
;; of loading by not having them when they are unneeded
(lazy-require [typed-racket/rep/type-rep (Error?)]
              [typed-racket/types/utils (fv)]
